...
/**
 * Class of the block that is mined by the nodes
 * 
...
public class Block {
    ...
    /**
     * Block class constructor. Initializes a new block with the provided
     * transaction and sets up default values.
     *
    ...
    /**
     * Retrieves the block's nonce. The nonce is a number that is used once in
     * cryptography.
     *
    ...
    /**
     * Retrieves the block's difficulty. The difficulty is a parameter that
     * determines the amount of work required to mine a block.
     *
