...
/**
 * This is the Node class that extends the BlockchainComponent class.
 * It represents a node in a blockchain.
 *
 ...
 * Initializes a new Node with the provided wallet.
 *
...
/**
 * Processes a message.
 * If the message is a TransactionNotification, it mines a block with the transaction.
 * If the message is a ValidateBlockRq, it validates the block.
 * If the message is a ValidateBlockRes, it commits the transaction.
 *
 ...
 * The string contains "Node#" and the formatted ID of the Node.
 *
 ...
 */
    ...
    /**
 * Creates a new transaction with the specified destination public key and balance.
 * If the balance is less than 0, it throws a TransactionException.
 * Otherwise, it creates a new transaction, adds it to the list of non-validated transactions, and returns it.
 *
...
/**
 * Creates a new transaction with the specified destination wallet and balance.
 * It calls the createTransactionMethod with the public key of the destination wallet and the balance.
 *
...
/**
 * Creates a new transaction with the specified destination public key and balance.
 * It calls the createTransactionMethod with the destination public key and the balance.
 *
 * @param destinationPublicKey The public key of the destination wallet.
 * @param balance The balance of the transaction.
 * @return The created transaction.
 ...
 */
    ...
    /**
 * Returns a string representation of the Node.
 * The string contains the string representation of the wallet and the full name of the Node.
 *
 * @return A string representation of the Node.
 */
    @Override
