...
/**
 * This is the BlockchainNetwork class that implements the IConnectable
 * interface. It represents a network in a blockchain.
 *
...
public class BlockchainNetwork implements IConnectable {
    ...
    /**
     * BlockchainNetwork class constructor. Initializes a new BlockchainNetwork
     * with the provided network name and sets the parent to null.
     *
    ...
    /**
     * Connects a new IConnectable data to the network. If the data is a Node or
     * MiningNode and already has a parent, it throws a ConnectionException. If
     * the data is already connected to the network, it throws a
     * DuplicateConnectionException. Otherwise, it adds the data to the
     * network's elements and sets the network as the data's parent.
     *
     * @param data The IConnectable data to connect to the network.
     * @return The network after the data has been connected.
     * @throws ConnectionException If the data is a Node or MiningNode and
     * already has a parent.
     * @throws DuplicateConnectionException If the data is already connected to
     * the network.
     */
    ...
    /**
     * Returns a string representation of the network. The string contains the
     * network's name, the number of elements in the network, and the string
